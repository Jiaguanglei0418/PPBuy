...
#import "PPRecentViewController.h"
#import "UIBarButtonItem+Extension.h"

@interface PPRecentViewController ()

@end

@implementation PPRecentViewController
...
- (instancetype)init
{
    ...
    return [[PPRecentViewController alloc] initWithCollectionViewLayout:flowLayout];
}
